...
// import { BidContext, CardRank, CARD_RANKS, getCardsInSuit, getPartnerBySeat, PlayContext, randomlySelect, Range, Seat, Strain, Suit, SUITS, Partnership, getSeatsByPartnership, getPartnershipBySeat } from "./common";
...
//   private selectSuit(context: PlayContext, dummy: Hand | null, cards: CardSet): Suit {
